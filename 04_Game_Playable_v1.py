...
class Start:
    def __init__(self, parent):
        ...
        self.push_me_button.grid(row=0, pady=10, padx=15)
...
class Game:
    def __init__(self, partner, stakes, starting_balance):
        ...
        self.stats_button = Button(self.help_export_frame, text="Games Stats...",
                                   font="Arial 15 bold",
                                   bg="#003366", fg="white")
...
if __name__ == "__main__":
    ...
    root.title("Mystery Box Game")
    something = Start(root)
>>>>>>> 03d2c0a0fe4fc0a77780f4f68493c474ae0a4618
    root.mainloop()