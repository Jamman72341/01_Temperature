...
class Converter:
    def __init__(self):
        ...
        self.to_c_button = Button(self.conversion_buttons_frame,
                                  ...
                                  bg="DeepSkyBlue2", padx=10, pady=10,
                                  command=lambda: self.temp_convert(-459))
        self.to_c_button.grid(row=0, column=0)

        self.to_f_button = Button(self.conversion_buttons_frame,
                                  text="To Fahrenheit", font="Arial 10 bold",
                                  bg="firebrick2", padx=10, pady=10,
        ...
        # History / Export button frame (row 5)
        self.hist_export_frame = Frame(self.converter_frame)
        self.hist_export_frame.grid(row=5, pady=10)

        self.history_button = Button(self.hist_export_frame, font="Arial 12 bold",
        ...
        self.export_button = Button(self.hist_export_frame, font="Arial 12 bold",
                                  text="export", width=5)
